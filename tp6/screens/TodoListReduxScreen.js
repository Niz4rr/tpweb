...
import AppBar from '../../tp5/components/AppBar';

export default function TodoListReduxScreen({ navigation }) {
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity onPress={() => navigation.navigate('DétailsRedux', item)}>
